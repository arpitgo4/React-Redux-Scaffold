...
module.exports = {
  ...
  module: {
      ...
      { test: /\.css$/, loaders: [ 'react-hot-loader', 'style-loader', 'css-loader', 'postcss-loader' ] },
      { test: /\.scss$/, loaders: [ 'react-hot-loader', 'style-loader', 'css-loader', 'sass-loader', 'postcss-loader' ] },
